const siteMetadata = {
  ...
  defaultTitle:
    "Debrah's Digital Solutions | Computer Repair & IT Services in Fairview, Alberta",

  defaultDescription:
    "Tech help at your doorstep — fast, friendly, and local. Debrah's Digital Solutions serves Fairview and surrounding Alberta communities with expert IT support, web development, digital training, automation, and technology consulting services.",

  keywords: [
    // High-priority local + service keywords
